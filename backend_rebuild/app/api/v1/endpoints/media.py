...
from app.schemas.media import MediaUploadSignatureRequest, MediaUploadSignatureResponse
...
@router.post("/upload-signature", response_model=MediaUploadSignatureResponse)
